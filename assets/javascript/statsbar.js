        ...
        .then(function(response){
          ...
          console.log(response.results)
            ...
            for (var i = 0; i < results.length; i++) {
              ...
              var player = {};
              player.intelligence = heroStatsInt;
              player.strength = heroStatsStr;
              player.speed = heroStatsSpd;
              player.durability = heroStatsDur;
              player.power = heroStatsPow;
              player.combat = heroStatsCom;
              ...
              var statColors = {};
              statColors.intelligence = "#993333";
              statColors.strength = "#993333";
              statColors.speed = "#993333";
              statColors.durability = "#993333";
              statColors.power = "#993333";
              statColors.combat = "#993333"
              ...
              var innerPolygonColor = statColors.intelligence;
